...
\begin{equation}
 \begin{aligned}
  \mathbb{W} &= \{\omega \in \Omega \rightarrow \mathbb{R}
  : \int_\Omega \omega^2 d\Omega < \infty 
  ; \omega = \omega_\Gamma\} \\
  \mathbb{P} &= \{\psi \in \Omega \rightarrow \mathbb{R}
  : \int_\Omega \psi^2 d\Omega < \infty 
  ; \psi = \psi_\Gamma\} \\
  \mathbb{E} &= \{e \in \Omega \rightarrow \mathbb{R}
...
\begin{equation}
 \begin{aligned}
  \mathbb{D} &= \{\delta \in \Omega \rightarrow \mathbb{R}
  : \int_\Omega \delta^2 d\Omega < \infty
  ; \delta_\Gamma = 0\} \\
  \mathbb{F} &= \{\phi \in \Omega \rightarrow \mathbb{R}
  : \int_\Omega \phi^2 d\Omega < \infty 
  ; \phi_\Gamma = 0\} \\
  \mathbb{N} &= \{\eta \in \Omega \rightarrow \mathbb{R}
