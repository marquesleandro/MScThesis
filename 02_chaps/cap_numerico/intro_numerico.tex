...
\begin{tikzpicture}[scale=0.7pt]
 ...
 \node (TriSim) at (1.5,2.7) {\textbf{TriSim}};

 \draw [line width=1pt] (0,6) rectangle ++(3,3);
 \draw [line width=1pt] (0,8.4) -- (3,8.4);
 \draw [line width=1pt] (0,7.6) -- (3,7.6);
 \node (TriMesh) at (1.5,8.7) {\textbf{TriMesh}};

 \draw [line width=1pt] (6,0) rectangle ++(3,3);
 \draw [line width=1pt] (6,2.4) -- (9,2.4);
 \draw [line width=1pt] (6,1.6) -- (9,1.6);
 \node (InOut) at (7.5,2.7) {\textbf{InOut}};

 \draw [line width=1pt] (-6,0) rectangle ++(3,3);
 \draw [line width=1pt] (-6,2.4) -- (-3,2.4);
 \draw [line width=1pt] (-6,1.6) -- (-3,1.6);
 \node (triBC) at (-4.5,2.7) {\textbf{TriBC}};

 \draw [line width=1pt] (0,-6) rectangle ++(3,3);
 \draw [line width=1pt] (0,-3.6) -- (3,-3.6);
 \draw [line width=1pt] (0,-4.4) -- (3,-4.4);
 \node (TElement) at (1.5,-3.3) {\textbf{TElement}};

 \draw [line width=1pt] (6,-6) rectangle ++(3.5,3);
 \draw [line width=1pt] (6,-3.6) -- (9.5,-3.6);
 \draw [line width=1pt] (6,-4.4) -- (9.5,-4.4);
 \node (FEMLinElement) at (7.8,-3.3) {\textbf{FEMLinElem}};

 \draw [{Diamond}-,line width=1pt] (TriSim) -- (1.5,6);
 \draw [{Diamond}-,line width=1pt] (0,1.5) -- (-3,1.5);
 \draw [{Diamond}-,line width=1pt] (1.5,0) -- (1.5,-3);
 \draw [{Diamond}-,line width=1pt] (3,1.5) -- (6,1.5);
 \draw [<-,line width=1pt] (3,-4.5) -- (6,-4.5);
