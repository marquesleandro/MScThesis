...
\usepackage{times} % nicer math font style
...
\newcommand{\legend}{\captionsetup{justification=raggedright,singlelinecheck=false,format=hang}}
\newcommand{\source}{\captionsetup{justification=raggedright,singlelinecheck=false}}
...
\pagebreak\thispagestyle{empty}\input{./00_pre/3catalogSheet_template}   
\pagebreak\thispagestyle{empty}\input{./00_pre/4approvalSheet_template}
...
%% ----- CHAPTERS  (02)
\input{./02_chaps/review.tex}
\input{./02_chaps/eqgov.tex}
\input{./02_chaps/mef.tex}
\input{./02_chaps/numerico.tex}
\input{./02_chaps/validation.tex}
\input{./02_chaps/solution.tex}
