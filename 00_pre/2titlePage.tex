...
\begin{flushright}
\parbox{8cm}{
\singlespacing{\large Master's Thesis presented to the Mechanical Engineering Graduate Program of Universidade do Estado do Rio de Janeiro (UERJ) as a pratial requirement to obtain the degree of Master in Sciences. \linebreak Field of concentration: Transport Phenomena.} 
}
\end{flushright}
